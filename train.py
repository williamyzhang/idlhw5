...
def main():
    ...
    if args.use_cfg and args.model_type != "dit":
        ...
        class_embedder = ClassEmbedder(
            ...
            cond_drop_rate=0.1 # 10% dropout rate for CFG training
        )
    ...
    # if is_primary(args):
    #     save_checkpoint(unet_wo_ddp, scheduler_wo_ddp, vae_wo_ddp, class_embedder, optimizer, args.num_epochs-1, save_dir=save_dir)
